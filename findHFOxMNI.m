function [m_HFOEvents, intervals,st_HFOData] = findHFOxMNI(EEG,ps_SignalIdx)                  
%% Variable declarations
s_SampleFrec=EEG.srate;
st_HFOData.s_FreqIni= 80;
st_HFOData.s_FreqEnd= floor(EEG.srate/2);
st_HFOData.s_EpochTime= 10;
st_HFOData.s_EpoCHF= 60;
st_HFOData.s_PerCHF= 95;
st_HFOData.s_MinWin= 10;
st_HFOData.s_MinGap= 10;
st_HFOData.s_ThresPerc= 99.9999;
st_HFOData.s_BaseSeg= 125;
st_HFOData.s_BaseShift= 0.5000;
st_HFOData.s_BaseThr=0.6700;
st_HFOData.s_BaseMin= 5;

v_Signal = EEG.data(ps_SignalIdx,:);
